...
a5_main_test: main.o Menu.o Player.o database.o
	g++ -o a5_main_test main.o Menu.o Player.o database.o

main:
	g++ -c $(CPPFLAGS) main.cpp

Menu:
	g++ -c $(CPPFLAGS) Menu.cpp Menu.h

Player:
	g++ -c $(CPPFLAGS) Player.cpp Player.h

database:
	g++ -c $(CPPFLAGS) database.cpp database.h

clean:
	rm -f a5_main_test main.o Menu.o Player.o database.o
